...
echo YELB_UI_SRC: $YELB_UI_SRC
echo YELB_UI_IMAGE: $YELB_UI_IMAGE
echo YELB_APP_SRC: $YELB_APP_SRC
echo YELB_APP_IMAGE $YELB_APP_IMAGE
...
deploy_images() {
    ...
    # docker tag mreferre/yelb-ui:0.7 ${YELB_UI_IMAGE} && docker push ${YELB_UI_IMAGE}
    # docker tag mreferre/yelb-appserver:0.5 ${YELB_APP_IMAGE} && docker push ${YELB_APP_IMAGE}
